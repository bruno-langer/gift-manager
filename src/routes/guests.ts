...
// import { RequestPostNew, ResponsePostNew, RequestPostLogin, ResponsePostLogin, RequestDelete, ResponseDelete, RequestPatch, ResponsePatch } from './guests'

// Database Models
// import User from '../models/Guest'

// Code
const guests = Router();

guests.get('/', (request: Request, response: Response) => {
